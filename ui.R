  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Overview & Example Dataset",h4(p("How to use this App")),
                         ...
                         a("Click here to download Academic paper on GenAI in the classroom PDF file", href = "https://www.researchgate.net/publication/380399899_Generative_AI_and_Usage_in_Marketing_Classroom"),br(),br(),
